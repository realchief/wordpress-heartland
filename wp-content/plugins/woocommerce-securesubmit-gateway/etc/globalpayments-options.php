...
return array(
    'enabled' => array(
        ...
        'label'       => __('Enable GlobalPayments', 'wc_securesubmit'),
        'type'        => 'checkbox',
        'description' => '',
        'default'     => 'no'
    ),
    ...
    'accountId' => array(
        'title'       => __('Account ID', 'wc_securesubmit'),
        'type'        => 'text',
        'description' => __('Get your connection settings from your account.', 'wc_securesubmit'),
        'default'     => ''
    ),
    'transactionPwd' => array(
        'title'       => __('Shared Secret', 'wc_securesubmit'),
        'type'        => 'text',
        'description' => __('Get your connection settings from your merchant account.', 'wc_securesubmit'),
        'default'     => ''
    ),
    'rebatePwd' => array(
        'title'       => __('Rebate Password', 'wc_securesubmit'),
        'type'        => 'text',
        'description' => __('Get your connection settings from your merchant account.', 'wc_securesubmit'),
        'default'     => ''
    ),
