...
class WC_Gateway_SecureSubmit_GlobalPayments_Data
{
    ...
    public function getService()
    {
        ...
        $config->merchantId     = $this->globalpayments->merchantId;
        $config->transactionPwd = $this->globalpayments->transactionPwd;
        if ('production' == $this->globalpayments->environment) {
    ...
    /**
     * Used in `globalpayments-review-order.php` to format `HpsBuyerData` and
