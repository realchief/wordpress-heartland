...
class WC_Gateway_SecureSubmit_GlobalPayments_Connect
{
    ...
    {
        $forgetFlag = isset($_POST['forget_globalpayments']) && wp_verify_nonce($_POST['_wpnonce'], 'globalpayments_remove_long_access_token');
        ...
        if ('pair' === $action && 'success' === $status) {
            try {
                ...
                add_user_meta(
                    get_current_user_id(),
                    '_globalpayments_long_access_token',
        ...
        include $path . 'templates/globalpayments-connect.php';
    }
}
